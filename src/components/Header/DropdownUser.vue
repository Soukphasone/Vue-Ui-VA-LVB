...
<template>
  <div class="hidden sm:block relative" ref="target">
    <button class="flex items-center focus:outline-none" @click="logOut">
    ...
    <!-- <div
        v-if="userData"
        v-show="dropdownOpen"
        class="absolute right-0 mt-4 flex w-62.5 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark z-99999 text-gray-600"
      >
