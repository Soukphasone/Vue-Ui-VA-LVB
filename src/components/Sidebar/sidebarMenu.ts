export const menuGroups = [
  {
    ...
    menuItems: [
      ...
      //   route: '#',
      //   children: [
      //     { label: '> Register', route: '/customer/register' },
      //     { label: '> Customer List', route: '/customer/list' },
      //     { label: '> Authorize Customer', route: '#' },
      //     { label: '> Reset Password', route: '/customer/resetpassword' }
      //   ]
      // },
      // {
      //   icon: `<svg
      ...
      //   route: '/',
      //   children: [
      //     { label: '> List Loan Account', route: '/' },
      //     { label: '> History Paid List', route: '/' },
      //   ]
      // }
      // // {
      //   icon: `<svg
...
export const menuGroupsBottom = [
  {
    ...
    menuItems: [
      ...
      //   label: 'Setting',
      //   route: '/',
      //   children: [{ label: 'Change Password', route: '#' }]
      // },
      // {
      //   icon: `<svg
      //             class="fill-current"
...
export const menuGroupsBottomBefore = [
  {
    // name: 'OTHERS',
    menuItems: [
      // {
