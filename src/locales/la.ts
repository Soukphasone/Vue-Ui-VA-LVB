export const la = {
  ...
  authorize: 'ອະນຸມັດ',
  authorize_auccess: 'ການອະນຸມັດສຳເລັດ',
  ...
  user_edit: 'ຜູ້ແກ້ໄຂ',
  do_you_want_authorize: 'ທ່ານຕ້ອງການອະນຸມັດແທ້ບໍ?',
  please_select_some_items: 'ກະລຸນາເລືອກລາຍການໃດໜຶ່ງ',
  sorry_try_later: 'ຂໍອະໄພ, ລະບົບເກີດຂໍ້ຜິດພາດ. ກະລຸນາລອງໃໝ່ພາຍຫຼັງ',
  ...
  fail: 'ເກີດຂໍ້ຜິດພາດ',
  reject: 'ປະຕິເສດ',
  reject_success: 'ການປະຕິເສດສຳເລັດ',
  rejected: 'ຖືກປະຕິເສດ',
  ever_reject_by: 'ເຄີຍຖືກປະຕິເສດໂດຍ',
  user_reject: 'ຜູ້ປະຕິເສດ',
